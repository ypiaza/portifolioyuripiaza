...
export const projects : itemProjects[] = [
    {id: 1, project: 'Clone Spotify', link:'https://clonespotify-psi.vercel.app/', img: spotify , description: 'Feito em React, JavaScript, Tailwind CSS'},
    ...
    {id: 3, project: 'Assistente por voz (Em andamento)', link:'https://ypiaza.github.io/EvA-projeto-test/', img: eva, description: 'Feito em React, JavaScript, Tailwind CSS'},
]
