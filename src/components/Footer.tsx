...
const Footer = () => {
  ...
  return (
    <div className='fixed z-50 bottom-2 right-2 md:left-14 md:flex items-center justify-center md:justify-between md:w-[91.7%] px-5 md:px-12 py-5 md:py-2 rounded-3xl border border-white/10 bg-[#202020]/50 backdrop-blur-md mt-2'>
