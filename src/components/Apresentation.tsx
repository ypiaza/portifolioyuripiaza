...
const Apresentation = () => {
    ...
    return (
        <div className="flex w-full lg:grid lg:grid-cols-2 items-center justify-between h-full lg:h-[25rem] px-14 py-14 rounded-3xl border border-white/10 bg-[#202020] mt-3">
