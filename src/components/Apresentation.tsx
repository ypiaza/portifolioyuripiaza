...
const Apresentation = () => {
    ...
    return (
        <div className="relative flex w-full lg:grid lg:grid-cols-2 items-center justify-between h-full lg:h-[25rem] p-10 md:p-14 rounded-[1.7rem] bg-white/10 backdrop-blur-[8px] border border-white/10 shadow-inner shadow-white/10">
